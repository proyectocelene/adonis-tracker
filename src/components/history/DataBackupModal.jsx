    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
          ...
          >
            <Sparkles size={14} /> Limpieza Borradores
          </button>
          <button
            type="button"
        ...
        {/* Sanitizar Registros Atípicos de Firebase */}
        <div style={{ marginBottom: '18px' }}>
          <button
            type="button"
            onClick={handleSanitizeHistory}
            style={{ width: '100%', padding: '10px', fontSize: '11px', borderRadius: '12px', background: '#f0fdf4', color: '#15803d', border: '1.5px solid #86efac', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
          >
            🩺 Sanitizar Historial (Corregir 90 reps/10 lbs, 115 reps y pruebas julio)
          </button>
        </div>
